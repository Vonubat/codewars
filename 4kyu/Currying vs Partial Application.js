...
// option_1
function curryPartial(fn, ...par) {
  if (par.length === 0 && fn.length === 0) {
    return fn();
  }

  const curried = (...args) => {
    if (fn.length > args.length) {
      return curryPartial(fn.bind(null, ...args));
...
// console.log(curryPartial(double));
// console.log(curryPartial(double, a));
// console.log(curryPartial(double)()(a));
